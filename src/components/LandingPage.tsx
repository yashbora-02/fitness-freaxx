    ...
    <div className="bg-black text-white">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="relative">
              <img 
                ...
                className="rounded-lg shadow-2xl w-full h-[400px] object-cover object-center scale-100"
              />
      ...
      <section id="services" className="py-20 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-gray-900 p-8 rounded-lg hover:bg-gray-800 transition-colors duration-300 group">
              ...
              <p className="text-gray-300">One-on-one coaching with certified trainers to maximize your results</p>
            </div>
            ...
            <div className="bg-gray-900 p-8 rounded-lg hover:bg-gray-800 transition-colors duration-300 group">
              ...
              <p className="text-gray-300">Customized meal plans designed to fuel your fitness journey</p>
            </div>
            ...
            <div className="bg-gray-900 p-8 rounded-lg hover:bg-gray-800 transition-colors duration-300 group">
              ...
              <h3 className="text-2xl font-bold mb-4">Group Workouts</h3>
              <p className="text-gray-300">High-energy group sessions that build community and motivation</p>
            </div>
            ...
            <div className="bg-gray-900 p-8 rounded-lg hover:bg-gray-800 transition-colors duration-300 group">
              ...
              <p className="text-gray-300">Advanced strength training programs for serious athletes</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-20">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div>
              ...
              <h2 className="text-4xl md:text-6xl font-black italic mb-4 text-black dark:text-white">WHAT YOU GET<br />WITH <span className="italic">FitnessFreaxx</span></h2>
              <p className="mb-6 text-lg text-gray-700 dark:text-gray-200">By signing up with <span className="font-bold">FitnessFreaxx</span>, you gain access to a wide range of exclusive benefits, including.</p>
              <button className="bg-red-600 hover:bg-red-700 text-white font-bold py-4 px-10 rounded-full text-xl tracking-widest transition">GET STARTED</button>
            </div>
            {/* Right: Image, Service Title, Description */}
            <div>
              <img src="https://images.pexels.com/photos/1954524/pexels-photo-1954524.jpeg?auto=compress&w=800" alt="Personal Training" className="rounded-lg shadow-xl w-full object-cover h-80 mb-6" />
              <h3 className="font-bold italic text-2xl mb-3 text-black dark:text-white">Offline Personalized Training Routines</h3>
              <p className="text-lg text-gray-700 dark:text-gray-200 mb-10">Prefer in-person sessions? Our certified trainers are available for one-on-one coaching at our partner gyms or your preferred location. Each session is tailored to your fitness level and goals.</p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="flex items-center gap-8">
              <img src="https://images.pexels.com/photos/4198023/pexels-photo-4198023.jpeg?auto=compress&w=800" alt="Nutrition Coaching" className="rounded-lg w-64 h-64 object-cover" />
              <div>
                <h4 className="font-bold italic text-2xl mb-4 text-black dark:text-white">Expert Nutritional Coaching</h4>
                <p className="text-lg text-gray-700 dark:text-gray-200">Fitness is 70% nutrition and 30% workout. Our certified nutritionists create meal plans tailored to your body type, preferences, and goals.</p>
              </div>
            </div>
            {/* Block 2: Home Training */}
            <div className="flex items-center gap-8">
              <img src="https://images.pexels.com/photos/1552103/pexels-photo-1552103.jpeg?auto=compress&w=800" alt="Home Training" className="rounded-lg w-64 h-64 object-cover" />
              <div>
                <h4 className="font-bold italic text-2xl mb-4 text-black dark:text-white">Home Training</h4>
                <p className="text-lg text-gray-700 dark:text-gray-200">No gym? No problem! Our home training plans use minimal equipment and are tailored to your schedule. We bring fitness to your living room literally.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-white dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-center text-lg text-gray-700 dark:text-gray-200 mb-14 max-w-2xl mx-auto">Our carefully curated fitness programs have been developed to ensure that every client can find a path that works best for them</p>
          <div className="grid md:grid-cols-3 gap-12">
            {/* Card 1 */}
            <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl flex flex-col items-center justify-start p-10 min-h-[800px]">
              <div className="bg-red-600 p-4 rounded-lg mb-8 flex justify-center">
                <img src="https://images.pexels.com/photos/3823039/pexels-photo-3823039.jpeg?auto=compress&w=800" alt="Yoga" className="w-96 h-96 object-cover rounded-xl" />
              </div>
              <h3 className="text-4xl font-black mb-6 text-black dark:text-white text-center">YOGA</h3>
              <p className="text-xl text-gray-700 dark:text-gray-200 text-center">Balance your body, mind, and spirit with our professionally led yoga sessions. Ideal for stress relief, flexibility, and overall well-being.</p>
            </div>
            {/* Card 2 */}
            <div className="bg-black rounded-2xl shadow-2xl flex flex-col items-center justify-start p-10 min-h-[800px] border-4 border-red-600">
              <div className="bg-red-600 p-4 rounded-lg mb-8 flex justify-center">
                <img src="https://images.pexels.com/photos/414029/pexels-photo-414029.jpeg?auto=compress&w=800" alt="Online Personal Training" className="w-96 h-96 object-cover rounded-xl" />
              </div>
              <h3 className="text-4xl font-black mb-6 text-red-600 text-center">ONLINE PERSONAL TRAINING</h3>
              <p className="text-xl text-gray-200 text-center">No matter where you are, you can train with our expert coaches through video calls and mobile-based fitness plans. Enjoy flexibility and accountability with fully customized workouts designed for your goals.</p>
            </div>
            {/* Card 3 */}
            <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl flex flex-col items-center justify-start p-10 min-h-[800px]">
              <div className="bg-red-600 p-4 rounded-lg mb-8 flex justify-center">
                <img src="https://images.pexels.com/photos/1552242/pexels-photo-1552242.jpeg?auto=compress&w=800" alt="Weight Loss" className="w-96 h-96 object-cover rounded-xl" />
              </div>
              <h3 className="text-4xl font-black mb-6 text-black dark:text-white text-center">WEIGHT LOSS PROGRAMS</h3>
              <p className="text-xl text-gray-700 dark:text-gray-200 text-center">Struggling with weight loss? Our comprehensive programs combine diet, exercise, and lifestyle changes to help you burn fat and build lasting habits. No gimmicks, just real, sustainable results.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-black dark:bg-black mb-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            {/* Transformation 1 */}
            <div className="bg-gray-900 rounded-2xl shadow-xl flex flex-col items-center p-6">
              <img src="https://images.pexels.com/photos/1130626/pexels-photo-1130626.jpeg?auto=compress&w=500" alt="Client Transformation 1" className="w-full h-72 object-cover rounded-xl mb-4" />
              <p className="text-lg text-gray-200 text-center italic">"Lost 20kg and gained confidence! The trainers at FitnessFreaxx changed my life."</p>
            </div>
            {/* Transformation 2 */}
            <div className="bg-gray-900 rounded-2xl shadow-xl flex flex-col items-center p-6">
              <img src="https://images.pexels.com/photos/1552242/pexels-photo-1552242.jpeg?auto=compress&w=500" alt="Client Transformation 2" className="w-full h-72 object-cover rounded-xl mb-4" />
              <p className="text-lg text-gray-200 text-center italic">"From zero to marathon runner! The personalized plans really work."</p>
            </div>
            {/* Transformation 3 */}
            <div className="bg-gray-900 rounded-2xl shadow-xl flex flex-col items-center p-6">
              <img src="https://images.pexels.com/photos/2261482/pexels-photo-2261482.jpeg?auto=compress&w=500" alt="Client Transformation 3" className="w-full h-72 object-cover rounded-xl mb-4" />
              <p className="text-lg text-gray-200 text-center italic">"I never thought I could feel this strong and healthy. Thank you, FitnessFreaxx!"</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-red-600">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-5xl font-black uppercase mb-6 tracking-tight text-white">
          ...
          <Link to="/contact">
            <button className="bg-black hover:bg-gray-800 text-white px-12 py-4 rounded-lg text-xl font-bold transition-all duration-300 transform hover:scale-105 shadow-2xl">
              GET STARTED NOW
            </button>
          </Link>
        </div>
      ...
      <section className="py-20 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <span className="block text-xl italic text-white mb-2 tracking-wide">WHAT THEY'RE SAYING</span>
            <div className="flex flex-col items-center">
              <div className="w-16 h-1 bg-red-600 mb-4"></div>
            </div>
            <h2 className="text-4xl md:text-6xl font-black italic text-white mb-12 tracking-tight">CLIENT TESTIMONIALS</h2>
          </div>
          <div className="grid md:grid-cols-3 gap-12">
            {/* Testimonial 1 */}
            <div>
              <p className="text-white text-xl mb-6">“I lost 12 kgs in just 4 months with the online training program! The workouts were fun and the diet plan was easy to follow. FitnessFreaxx changed my life.”</p>
              <span className="text-red-600 font-bold tracking-wide">Ritika Sharma – Online Training Client</span>
            </div>
            {/* Testimonial 2 */}
            <div>
              <p className="text-white text-xl mb-6">“I have a hectic job, but the home training plan fit perfectly into my routine. The trainer was super professional and always motivated me to push harder.”</p>
              <span className="text-red-600 font-bold tracking-wide">Arun Mehta – Home Training Client</span>
            </div>
            {/* Testimonial 3 */}
            <div>
              <p className="text-white text-xl mb-6">“I struggled with weight for years. The personalized nutrition plan, combined with weekly check-ins, helped me drop 10 kgs and keep it off!”</p>
              <span className="text-red-600 font-bold tracking-wide">Rahul Verma – Nutrition & Weight Loss Client</span>
            </div>
          </div>
        </div>
      </section>
